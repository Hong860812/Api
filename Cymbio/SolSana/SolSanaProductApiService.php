...
/**
 * Class SolSanaProductApiService
 * @package App\Features\Cymbio\SolSana
 */
class SolSanaProductApiService extends CymbioProductApiService
{
    ...
    /**
     * SolSanaProductApiService constructor.
    ...
    public function __construct(AttributeLangRepo $attributeLangRepo, Client $client)
    {
        ...
        $this->retailId = config('cymbio.' . env('APP_ENV') . '.SolSana.RETAILER_ID');
    }
